  ...
  return (
    <Card className="bg-gray-900/50 border-blue-500/30 shadow-lg shadow-blue-500/10">
      <CardHeader className="bg-blue-500/10 border-b border-blue-500/30">
        <CardTitle className="text-lg font-bold text-blue-400 font-mono">[ WANTS - 30% ]</CardTitle>
      </CardHeader>
      <CardContent className="p-0">
        <div className="overflow-x-auto">
          <table className="w-full text-sm font-mono">
            <thead className="bg-gray-800/50 border-b border-blue-500/30">
              <tr>
                <th className="px-3 py-2 text-left font-semibold text-blue-300">CATEGORY</th>
                <th className="px-3 py-2 text-right font-semibold text-blue-300">BUDGET</th>
                <th className="px-3 py-2 text-right font-semibold text-blue-300">ACTUAL</th>
                <th className="px-3 py-2 text-right font-semibold text-blue-300">DIFF</th>
                <th className="px-3 py-2 text-center font-semibold text-blue-300">DEL</th>
              </tr>
            </thead>
            <tbody>
              {data.map((item, index) => {
                  ...
                  <tr key={index} className="border-b border-gray-700/50 hover:bg-blue-500/5">
                    <td className="px-3 py-2">
                      <Input
                        ...
                        className="border-0 p-0 h-auto bg-transparent text-blue-300 font-mono"
                      />
                    </td>
                    <td className="px-3 py-2">
                      <Input
                        ...
                        className="border-0 p-0 h-auto bg-transparent text-right text-blue-300 font-mono"
                      />
                    </td>
                    <td className="px-3 py-2">
                      <Input
              ...
              <tr className="border-b border-gray-700/50 bg-gray-800/25">
                <td className="px-3 py-2">
                  <Input
                    ...
                    className="border-0 p-0 h-auto bg-transparent placeholder:text-gray-500 text-blue-300 font-mono"
                  />
                </td>
                <td className="px-3 py-2">
                  <Input
            ...
            <tfoot className="bg-blue-500/10 border-t border-blue-500/30">
              <tr>
                <td className="px-3 py-3 font-bold text-blue-400 font-mono">TOTAL</td>
                <td className="px-3 py-3 text-right font-bold text-blue-400 font-mono">{formatCurrency(totalBudget)}</td>
                <td className="px-3 py-3 text-right font-bold text-blue-400 font-mono">{formatCurrency(totalActual)}</td>
